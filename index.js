$(function(){
    ...
    let introTitle = document.querySelectorAll(".intro__title div");
    let txt = "Hi,";
    let txt2 = "I'm Giorgi,";
    ...
    function word(){
        if(wordWrap<txt.length){
            introTitle[0].innerHTML+=txt.charAt(wordWrap);
            wordWrap++;
            setTimeout(word,120);
        }
        else if (wordWrap === txt.length){
            word2()
        }
    }

    function word2(){
        if (wordWrap2<txt2.length){
            introTitle[1].innerHTML+=txt2.charAt(wordWrap2);
            wordWrap2++;
            setTimeout(word2,120);
        }
        else if (wordWrap2 === txt2.length){
            word3()
        }
    }

    function word3(){
        if (wordWrap3<txt3.length){
            introTitle[2].innerHTML+=txt3.charAt(wordWrap3);
            wordWrap3++;
            setTimeout(word3,120);
        }
    }
    ...
    function Dot(id, x, y, r) {
        ...
        this.color = "rgba(255,255,255,"+1+")";
        this.linkColor = "rgba(255,0,0,"+this.a/4+")";
